...
// ../../../npm-cache/_npx/1e7f6d9597241db0/node_modules/@deepseek-ai/schemastery/lib/index.mjs
...
var Config = Schema.object({
  ...
  outDir: Schema.string().default("output"),
  timeoutMs: Schema.number().default(6e5),
  maxOutputBytes: Schema.number().default(64e3)
});
...
var DESCRIPTION = "\u5BF9\u4E00\u7BC7\u6216\u591A\u7BC7\u5916\u6587 PDF \u5B66\u672F\u6587\u732E\u6267\u884C\u63D0\u53D6\u3001\u4E2D\u6587\u7FFB\u8BD1\u3001\u56FE\u7247\u63D0\u53D6\u4E0E\u89E3\u8BFB\uFF0C\u8FD4\u56DE\u7ED3\u6784\u5316\u8F93\u51FA\u6587\u4EF6\u6E05\u5355\u3002\u7FFB\u8BD1/\u89C6\u89C9\u7684 API Key \u5DF2\u5728\u63D2\u4EF6\u914D\u7F6E\u4E2D\u63D0\u4F9B\uFF0C\u4E0D\u9700\u8981\uFF08\u4E5F\u4E0D\u5E94\u8BE5\uFF09\u5728\u53C2\u6570\u91CC\u4F20 Key\u3002\u9002\u5408\u7528\u6237\u53D1\u6765 PDF \u6587\u732E\u5E76\u8981\u6C42\u9605\u8BFB\u3001\u7FFB\u8BD1\u3001\u5206\u6790\u3001\u603B\u7ED3\u6216\u6279\u91CF\u5904\u7406\u65F6\u4F7F\u7528\u3002";
var PARAMETERS = {
  type: "object",
  properties: {
    pdfs: {
    ...
    vision: {
      type: "boolean",
      description: "\u7528\u5916\u90E8\u89C6\u89C9\u6A21\u578B\u89E3\u8BFB\u56FE\u7247\uFF08OpenAI \u517C\u5BB9\uFF0C\u5982 gpt-4o/Qwen-VL/GLM-4V\uFF09\uFF1B\u9700 config.json \u5DF2\u914D\u7F6E vision \u6BB5\u3002DeepSeek \u6587\u672C\u6A21\u578B\u672C\u8EAB\u4E0D\u80FD\u770B\u56FE\u3002"
    },
  ...
  const definition = {
    ...
    async execute(args, exec) {
      ...
      const argv = [
        ...
        outDirAbs,
        "--formats",
        a.formats ?? config.defaultFormats,
        "--json-out",
        jsonPath
      ];
      ...
      const detail = (stderr || stdout).trim().slice(-2e3);
      throw new Error(`pdfreader \u5931\u8D25\uFF08exit ${outcome.exitCode ?? "signal"}\uFF09: ${detail || "\u65E0\u8F93\u51FA"}`);
    },
    presentCall: (args) => {
      const raw = args ?? {};
      const pdfs = Array.isArray(raw.pdfs) ? raw.pdfs.filter((p) => typeof p === "string") : [];
      return {
        card: "terminal",
